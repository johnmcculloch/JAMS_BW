...
make_colour_dictionary<-function(variable_list=NULL, pheno=NULL){
    ...
    JAMSpalettenames<-c("royalblue4", "red1", "purple2", "orange2", "chocolate4", "navyblue", "green", "violet", "turquoise2", "tomato", "tan3", "steelblue3", "springgreen2", "violetred1", "slategray3", "wheat3", "violetred4",  "sienna3", "black")
