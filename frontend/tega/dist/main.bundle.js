...
ipcMain.on('navigate-to', function (event, page) {
...
ipcMain.handle('open-file-dialog', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
ipcMain.handle('load-rdata-file', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event, filePath) {
    var script;
...
// HEATMAP Script 
ipcMain.handle('run-heatmap-script', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event, params) {
    var filePath, ExpObj, advancedSettings, otherParams, paramStr, outputFilePath, script;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          // Log the params object for debugging
          console.log('Recieved params:', params);
          filePath = params.filePath, ExpObj = params.ExpObj, advancedSettings = params.advancedSettings, otherParams = _objectWithoutProperties(params, _excluded); // Construct paramStr dynamically to account for anything the user inputs
          paramStr = "ExpObj = ".concat(ExpObj, ", ") + Object.entries(otherParams).map(function (_ref4) {
          ...
          outputFilePath = path.join(__dirname, 'assets', 'heatmap.pdf');
          script = "\n    Rscript -e '\n    suppressPackageStartupMessages({\n    load(\"".concat(filePath, "\");\n    library(JAMS); \n    source(\"/Users/mossingtonta/Projects/JAMS_BW/R/plot_relabund_heatmap.R\"); \n    pdf(\"").concat(outputFilePath, "\");\n    plot_relabund_heatmap(").concat(paramStr, ")\n    dev.off();\n    })'\n  ");
